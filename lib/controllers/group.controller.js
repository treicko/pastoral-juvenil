...
class GroupController {
  ...
  saveGroup(data) {
    Meteor.call('insertGroup', data.newGroup, (error, groupId) => {
      if (!error) {
        ...
        this.notificationController.setGroupCreatedNotification({
          inCharges: data.newGroup.inCharges,
          members: data.newGroup.members,
          groupName: data.newGroup.name,
          entityId: groupId,
        });
      }
    });
  ...
  savePublication(data) {
    Meteor.call('insertPublication', data.newPublication);
    this.notificationController.setGroupPublicationCreatedNotification({
      inCharges: data.group.inCharges,
      members: data.group.members,
      groupName: data.group.name,
      entityId: data.group._id,
    });
  }

  saveComment(data) {
    Meteor.call('insertComment', data.newComment);
    this.notificationController.setGroupCommentPublicationCreatedNotification({
      inCharges: data.group.inCharges,
      members: data.group.members,
      groupName: data.group.name,
      entityId: data.group._id,
