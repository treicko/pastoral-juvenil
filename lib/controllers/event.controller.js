...
class EventController {
  ...
  setEventForEditOnMap(eventId, entityLocationForm) {
    ...
    if (eventFound && this.map) {
      ...
      this.map.addPlacesSearchBoxControlToEntity(eventFound.radius, entityLocationForm);
    }
  }
  ...
  setEventForCreate(entityLocationForm) {
    ...
    this.map.addCurrentLocationControl(entityLocationForm, true);
    console.log('On event fo createeeeeeeee');
    this.map.addPlacesSearchBoxControlToEntity(100, entityLocationForm);
  }
